...
In the first stage I will only collect data for a single station. I decided to focus in a data from a station called *Newe Ya'ar*. The station located near a small vilage called *Ramat Yishai*. The reason I am choosing to work on this station:
